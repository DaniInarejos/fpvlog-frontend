      ...
      <div class="space-y-4">
        ...
        <dl class="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div class="flex justify-between sm:block">
            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ t('components.form.brand') }}</dt>
            <dd class="text-sm text-gray-900 dark:text-gray-100">{{ component.brand || '-' }}</dd>
          </div>
          <div class="flex justify-between sm:block">
            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ t('components.form.weight') }}</dt>
          ...
          <div v-if="component.sourceUrl" class="flex justify-between sm:block">
            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ t('components.form.sourceUrl') }}</dt>
        ...
        <div v-if="component.description">
          <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ t('components.form.description') }}</h3>
